...
5) We also provide the [``survey``](https://github.com/stilab-ets/iacreview/blob/main/Survey) conducted with 9 OpenStack developers for the validation of our checklist .
